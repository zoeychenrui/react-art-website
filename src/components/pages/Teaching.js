    ...
    return (
        ...
        <div className='container'>
            ...
            <div className="column">
                ...
                <Slider name="pandaClass/" text="panda 4.5.2020" url="/panda"/>
                <Slider name="sunflowersClass/" text="sunflowers 4.26.2020" url="/sunflowers"/>
                <Slider name="rainbowSkyClass/" text="rainbow sky 5.24.2020" url="/rainbowSky"/>
                <Slider name="fireflyClass/" text="firefly 5.17.2020" url="/firefly"/>
                <Slider name="abstractFlowersClass/" text="abstract flowers 6.14.2020" url="/abstractFlowers"/>
                <Slider name="flowersClass/" text="flowers 4.12.2020" url="/flowers"/>
            ...
            <div className="column">
                ...
                <Slider name="littleBirdClass/" text="little bird 5.3.2020" url="/littleBird"/>
